...
echo "📖 This script will help you running the metadata service for the first time. It will try to setup everything"
...
docker compose up metadata_db -d
...
echo "🏁 Autopilot completed. You should be able to go to your web browser and access the application at http://localhost:8503/docs."
